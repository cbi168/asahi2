...
@section('title', '編輯文章')
@section('page-title', '編輯文章')
@section('breadcrumb', '編輯文章')
      ...
      <form action="{{ route('admin.articles.update', $article) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <small class="form-text text-muted">支援格式：JPG、JPEG、PNG、WEBP，最大 5MB。留空則不變更圖片。</small>
          ...
          <div class="form-group">
            ...
            <input type="date" name="publish_date" id="publish_date"
                   ...
                   value="{{ old('publish_date', $article->publish_date->format('Y-m-d')) }}" required>
            @error('publish_date')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="form-group">
            <div class="custom-control custom-checkbox">
              <input type="checkbox" name="is_active" id="is_active" class="custom-control-input"
                     value="1" {{ old('is_active', $article->is_active) ? 'checked' : '' }}>
